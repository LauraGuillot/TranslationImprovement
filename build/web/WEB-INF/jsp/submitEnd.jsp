...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="css/SubmitEnd.css">
    ...
    <body onload="pop();">
        ...
        <div class="main">
            ...
            <div id="playEnd" >
                ...
                <div id = "results">
                    <br><br>
                    We have all registered in our database !
                    <br><br>
                    The community will now evaluate your submissions.
                </div>
                <div id = "earn">
                    <h1 id="s1" >You earn </h1><br>
                    <h1 id="s2"><c:out value="${cpt}"/></h1>
                    <h1 id="s1" >pts</h1>
                </div>
                <div id="missions">
